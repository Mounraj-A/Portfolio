...
export default function AchievementDeleteModal({ open, achievement, onClose, onConfirm }) {
  const title = achievement?.title || 'this achievement'
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-3 font-poppins text-2xl font-extrabold">
                        <span className="gradient-text">Delete achievement</span>
                      </h3>
                      <p className="mt-2 text-sm text-muted">
                        This will remove <span className="text-text">{title}</span> from your portfolio.
                      </p>
                    </div>
                    <button
                      type="button"
                  ...
                  <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-xs text-muted">
                        This action is permanent. Your portfolio Achievements section will update instantly.
                      </div>
                    </div>
                  </div>
