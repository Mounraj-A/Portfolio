...
export default function ServiceDeleteModal({ open, service, onClose, onConfirm }) {
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-3 font-poppins text-2xl font-extrabold">
                        <span className="gradient-text">Delete service</span>
                      </h3>
                  ...
                  <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="text-xs text-muted">
                        This action is permanent. Your portfolio Services section will update instantly.
                      </div>
                    </div>
                  </div>
